...
class UserScalesScreen extends StatelessWidget {
  ...
  UserScalesScreen() {
    this.user_scales = ['Scale1Name', 'scale1pattern', 'Scale2Name', 'scale2pattern'];  //TODO: GET THEM FROM FILE
  }

  List<String> readScales() {
